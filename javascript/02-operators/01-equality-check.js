function main() {
  ...
  // moneyCheckWeak    /*TODO uncomment this line of code and assign it to an equality check (weak) testing if moneyOwn and amountDue are the same */
  // moneyCheckWeak    /*TODO uncomment this line of code and assign it to an equality check (strong) testing if moneyOwn and amountDue are the same */
